    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Input Angkutan</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">Input Data</li>
                            <li class="breadcrumb-item active">Angkutan</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods: {
            LoadData() {
                axios.get('/api/data-kendaraan').then(({
                    ...
                    let dataKendaraan = _.pickBy(data, function (u) {
                        return u.status == 'AKTIF';
                    });
                    this.kendaraan = dataKendaraan;
                });
            ...
            fillAsal(value) {
                let nama = value;
                let asal = _.pickBy(this.muatan, function (u) {
                    return u.muatan == nama;
                });
            ...
            insert() {
                this.$Progress.start();
                this.form.post('/api/angkutan')
                    .then(() => {
                        Toast.fire({
                            icon: 'success',
                            title: 'Informasi Angkutan Berhasil Disimpan'
                        });
        ...
        mounted() {
            document.title = 'Annisa Rizki - Input Angkutan';
