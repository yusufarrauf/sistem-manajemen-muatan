...
class CreateAngkutanSupirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('angkutan_supirs', function (Blueprint $table) {
        ...
        Schema::table('angkutan_supirs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('angkutan_supirs');
    }
}
